  ...
  return (
    <header className="sticky top-0 z-50 bg-black/95 backdrop-blur border-b border-zinc-800">
      <div className="bg-zinc-900 text-xs text-center py-2 tracking-wider text-zinc-300">
        ...
        <div>
          ENVIOS GRÁTIS A PARTIR DE 80€ • ENTREGA EM 2 SEMANAS • PAGAMENTOS SEGUROS
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-2 hover:text-amber-500 transition hidden sm:block"
              title="Instagram"
            >
              <Instagram size={20} />
            </a>
            <button
              ...
              className="p-2 hover:text-amber-500 transition"
              title="Pesquisar"
            >
              <Search size={20} />
            </button>
        ...
        {searchOpen && (
          <form onSubmit={doSearch} className="pb-4 flex gap-2">
            ...
            <button
              type="submit"
              className="bg-amber-500 text-black px-4 py-2 text-sm font-semibold rounded hover:bg-amber-400"
            >
              Buscar
            </button>
          </form>
