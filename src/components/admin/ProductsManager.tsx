...
export default function ProductsManager() {
  ...
  const onFile = (e) => {
    ...
    if (file.size > 1.5 * 1024 * 1024) { alert("Max 1,5 MB ou usa link https"); return }
    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-950">
          ...
          <input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="Nome" className="w-full bg-zinc-900 border border-zinc-700 px-3 py-2 rounded 
@'
"use client"
import { useProducts } from "@/store/products-store"
import { categories } from "@/lib/products"
    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="border border-zinc-800 rounded-lg p-4 space-y-3 bg-zinc-950">
          ...
          <p className="text-xs text-zinc-400">Foto da galeria (Android / iPhone / PC)</p>
          ...
          <input value={form.image.startsWith("data:") ? "" : form.image} onChange={(e) => setForm({ ...form, image: e.target.value })} placeholder="Ou link https:// da foto" className="w-full bg-zinc-900 border border-zinc-700 px-3 py-2 rounded text-sm" />
