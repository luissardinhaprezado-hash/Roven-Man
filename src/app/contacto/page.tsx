  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-16">
      ...
      <p className="text-zinc-400 text-sm mb-8">
        Tem alguma dúvida sobre um pedido ou produto? Envia-nos uma mensagem.
      </p>

      {sent ? (
        <div className="border border-green-900 bg-green-950/30 p-6 rounded text-green-300 text-sm">
          Mensagem enviada (modo demonstração). Responderemos o mais breve possível.
        </div>
      ) : (
        <form
          onSubmit={(e) => {
        ...
        >
          ...
          <button
            type="submit"
            className="bg-amber-500 text-black px-6 py-3 font-semibold hover:bg-amber-400 transition"
          >
            ENVIAR
          </button>
        </form>
